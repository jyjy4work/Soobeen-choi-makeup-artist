      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        {settings?.whatsappNumber && (
          <a
            ...
            className="inline-flex items-center justify-center gap-3 px-10 py-4
              bg-[#25D366] text-white text-[11px] tracking-[0.35em] font-display font-medium
        ...
        {settings?.instagramUrl && (
          <a
            ...
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-3 px-10 py-4
              border border-brand-100 text-brand-50 text-[11px] tracking-[0.35em] font-display font-medium
