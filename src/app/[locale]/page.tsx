          ...
          <div className="flex flex-wrap items-center gap-6 animate-fade-in-up animate-delay-400">
            ...
            {settings?.instagramUrl && (
              <a
                ...
                className="flex items-center gap-2 text-brand-50 hover:text-brand-100 transition-colors"
              >
                ...
                <span className="text-[10px] tracking-[0.3em] uppercase font-medium">Instagram</span>
              </a>
            )}
          </div>
        </div>
